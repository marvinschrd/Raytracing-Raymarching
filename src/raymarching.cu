...
// nothing finished or working but what we where trying to do when trying to understand CUDA

//global void render(maths::Vector3f *framebuffer, int max_x, int max_y, float fov)
//{
